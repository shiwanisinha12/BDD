...
public class LoginStep {
	...
	{
		driver.findElement(By.cssSelector("#txt1")).sendKeys(arg);
		//driver.findElement(By.cssSelector("#names")).sendKeys(arg);
	}
	
	@And("^I enter the password as (.*)$")
	public void sendPassword(String arg)throws Throwable
	{
		driver.findElement(By.cssSelector("#txt2")).sendKeys(arg);
		//driver.findElement(By.cssSelector("input[value='names']")).sendKeys(arg);
	}
